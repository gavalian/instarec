 ...
 * @author tyson
 */
public class TrainingElPIDRadPhotons_GBT {
  ...
  public static void trainNetwork(String dataPath, String networkPath) {
    ...
    /*XGBoostNetwork network = new XGBoostNetwork(6); // number of inputs
    network.createClassifier();
    //network.createRegression(); // -- for regression us this

    network.setEpochs(1250);
    network.train(dset);

    network.save("boosted_tree.json");*/
  ...
  public static void testNetwork(String dataPath, String networkPath, int sector, double effLow) {
    ...
    TrainingElPIDRadPhotons_GBT.findBestThreshold(data,model,1,effLow,sector);
  ...
  public static void main(String[] args) {
    ...
    /*for (int j = 1; j < 7; j++) {
      ...
      TrainingElPIDRadPhotons_GBT.transferTraining(dataPath, networkPath,networkPathOut, j);
      TrainingElPIDRadPhotons_GBT.testNetwork(dataPath, networkPathOut, j,desiredThreshold);
    }*/

    //train from scratch
    TrainingElPIDRadPhotons_GBT.trainNetwork(dataPath,networkPathOut);
    TrainingElPIDRadPhotons_GBT.testNetwork(dataPath, networkPathOut, 0,desiredThreshold);
