 ...
 * @author tyson
 */
public class RunAppElasticScatteringTagger {
    ...
    public static List<DataActor>  createActors(int nactors, int nframes, List<DataWorker> workers){
        ...
        for(int a = 0; a < nactors; a++){
            ...
            DataFrame frame = RunAppElasticScatteringTagger.createFrames(nframes);
    ...
    public static void main(String[] args){
        ...
        HipoWriter w = HipoWriter.create("wLargeTagged.h5", r);
        ...
        ElasticScatteringTagger   elScatteringTagger = new ElasticScatteringTagger();
        
        finder.initNetworks();
        
        List<DataWorker>  workers = Arrays.asList(convert,dcwrk, finder, ecalfinder, ftoffinder, htcc, elPID, convertParticleCFTraining,elScatteringTagger);
        
        List<DataActor>   actors = RunAppElasticScatteringTagger.createActors(4, 128, workers);
